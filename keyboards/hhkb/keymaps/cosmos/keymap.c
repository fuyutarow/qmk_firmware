...
#define KC_NUMSLASH LT(_NUMS, KC_SLASH)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_EXCITE] = LAYOUT( 
    ...
    KC_ESC, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  KC_BSPC, KC_ESC,
    KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, LSFT(KC_TAB), KC_TAB,
    LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_FIGCOLON, KC_QUOT, KC_ENTER,
    LT(_NUMS, KC_ESC), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_NUMSLASH, KC_RSFT, TO(_BASE),
 ...
 [_FIG] = LAYOUT(
    ...
    RSFT_T(KC_ESC), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_ENT, KC_COMM, KC_DQT, KC_SLSH, KC_RSFT, RESET,
    LALT_T(KC_LANG1), LGUI_T(KC_LANG2), KC_CAPSPACE, LT(_SYMS, KC_LANG1), KC_RALT
  ),
  ...
  [_CAPS] = LAYOUT(
    ...
    LSFT(KC_ESC), KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,  _______,_______,
    ...
    LSFT(KC_LCTL), LSFT(KC_A), LSFT(KC_S), LSFT(KC_D), LSFT(KC_F), LSFT(KC_G), LSFT(KC_H), LSFT(KC_J), LSFT(KC_K), LSFT(KC_L), KC_COLON, KC_DQT, LSFT(KC_ENTER),
  ...
  [_SYMS] = LAYOUT(
    ...
    KC_GRV, KC_QUES, KC_MINS, KC_EQL, KC_ASTERISK, KC_AMPERSAND, KC_PIPE, KC_DQT, KC_LCBR, KC_RCBR, KC_COLN, KC_DQT, _______,
